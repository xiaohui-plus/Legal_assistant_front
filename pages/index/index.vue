		...
		<view class="main-content">
			<view class="chat-header">
				...
				<view class="header-actions">
					...
					<button class="header-btn" @click="exportChat" title="导出对话">📤</button>
				</view>
			</view>
			...
			<view class="welcome-screen" v-if="showWelcome">
				...
				<view class="welcome-features">
					...
					<view class="feature-card" @click="startChat('案例分析')">
						<view class="feature-icon">⚖️</view>
						<view class="feature-title">案例分析</view>
						<view class="feature-desc">专业的法律案例解析和风险评估</view>
					</view>
				</view>
			</view>
			...
			<view class="input-area" v-if="!showWelcome">
				<view class="quick-questions">
					...
					<view class="quick-question" @click="sendQuickQuestion('房屋租赁纠纷怎么办？')">租赁纠纷</view>
				</view>
