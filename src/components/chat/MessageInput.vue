  ...
  <view class="message-input-container">
    <view class="input-wrapper" :class="{ focused: isFocused }">
      ...
      <view class="action-button" @click="handleAttachment">
        <Icon icon="heroicons:paper-clip-20-solid" class="button-icon" />
      </view>
      ...
      <view class="right-actions">
        ...
        <view class="action-button" @click="handleVoice">
          <Icon icon="heroicons:microphone-20-solid" class="button-icon" />
        </view>
        ...
        <view
          ...
          @click="handleSend"
        >
          <Icon icon="heroicons:paper-airplane-20-solid" class="send-icon" />
        </view>
      </view>
    </view>
